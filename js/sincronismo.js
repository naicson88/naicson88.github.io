...
var firebaseConfig = {
  ...
  function registrar(titulo,solucao,problema){
        ...
        let db = firebase.database().ref("Sincronismo/"+counter);
        db.set(reg);
...
function listarCadastros(){
        ...
        var task = firebase.database().ref("Sincronismo/");
  ...
  function updateRegistroModal(id,titulo,problema,solucao){
    ...
    let db= firebase.database().ref("Sincronismo/"+id);
    db.set(updated);
    listarCadastros();
    reset();
  ...
  function deletarRegistro(id){
    var reg = firebase.database().ref("Sincronismo/"+id);
