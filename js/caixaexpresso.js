...
var firebaseConfig = {
  ...
  function registrar(titulo,solucao,problema){
        ...
        let db = firebase.database().ref("Registros/"+counter);
        db.set(reg);
...
function listarCadastros(){
        ...
        var task = firebase.database().ref("Registros/");
  ...
  function updateRegistroModal(id,titulo,problema,solucao){
    ...
    let db= firebase.database().ref("Registros/"+id);
    db.set(updated);
    listarCadastros();
    reset();
  ...
  function deletarRegistro(id){
    var reg = firebase.database().ref("Registros/"+id);
